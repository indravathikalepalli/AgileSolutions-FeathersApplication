...
MongoClient.connect('mongodb://localhost:27017/feathers_app',{ useNewUrlParser: true, useUnifiedTopology: true })
  .then(function(client){
    // Set the model now that we are connected
    app.service('messages').Model = client.db('feathers_app').collection('messages');
